...
from torch.optim.lr_scheduler import LambdaLR  # Import scheduler
import os
...
# --- Step 6: Chuẩn bị optimizer và scheduler ---
optimizer = torch.optim.AdamW(pipeline.parameters(), lr=2e-5, betas=(0.9, 0.999), eps=1e-8, weight_decay=0.01)

# Tạo WarmupLR scheduler (tương tự DeepSpeed)
def warmup_lr(step):
    warmup_steps = 100
...
# --- Step 7: Chuẩn bị model, optimizer, scheduler và dataloader với Accelerator ---
...
# --- Step 8: Cấu hình TrainingArguments ---
